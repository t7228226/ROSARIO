        ...
        <div className="control-card">
          ...
          {currentUser ? (
            <div className="logged-user">
              ...
              <span>{currentUser.id}｜{currentUser.role}</span>
